...
export default function Tweet({contentAdded, OnContentAdded} : {contentAdded: boolean, OnContentAdded: () => void}) {
    ...
    const getContent = async () => {
      if (contentAdded == true || Loading == true) {
        const res = await axios.get(`${BACKEND_URL}/v1/secondBrain/content/tweet`, {
          headers: {
